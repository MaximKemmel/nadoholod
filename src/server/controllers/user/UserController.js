...
exports.authMe = exports.login = void 0;
...
var authMe = function (request, response) {
    try {
        connectionPool_1.connectionPool.query('SELECT * FROM users WHERE id="' + request.id + '"', function (error, data) { return __awaiter(void 0, void 0, void 0, function () {
