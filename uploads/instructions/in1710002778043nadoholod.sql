...
--
-- Хост: 127.0.0.1
-- Время создания: Мар 01 2024 г., 18:50
...
(8, 'Холодильные моноблоки', '', 1, '/categories/im1709303314961.png', 0),
(9, 'Холодильные сплит-системы', '', 1, '/categories/im1709303355638.png', 0),
(10, 'Холодильные агрегаты', '', 1, '/categories/im1709303389577.png', 0);
...
INSERT INTO `products` (`id`, `category_id`, `name`, `description`, `full_description`, `price`, `delivery_info`, `instruction_path`, `manufacturer_id`) VALUES
(2, 1, 'Генератор ледяной воды', '<p>Температура от +10°С до -18°С Толщина сэндвич-панели 80мм</p>', '', 17071, '', '', 1);
